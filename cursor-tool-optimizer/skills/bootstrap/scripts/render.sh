...
#         TO_STATE_DIR  harness-agnostic state-dir umbrella (default: .claude). The Cursor
#                       host sets it to .cursor; explicit TO_INVENTORY / TO_RENDER_OUT win.
#         TO_INVENTORY  path to the inventory JSON   (default: ${TO_STATE_DIR}/tool-optimizer.local.json)
...
#                       (default: ${TO_STATE_DIR}/tool-optimizer.local.md)
...
INVENTORY="${TO_INVENTORY:-${STATE_DIR}/tool-optimizer.local.json}"
RENDER_OUT="${TO_RENDER_OUT:-${STATE_DIR}/tool-optimizer.local.md}"
