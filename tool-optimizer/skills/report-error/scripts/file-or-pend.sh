...
#                         ".claude/tool-optimizer.pending-reports.jsonl" relative to CWD
#                         (same directory convention as the breadcrumb). Override in tests
...
PEND_FILE="${TO_FOP_PEND:-.claude/tool-optimizer.pending-reports.jsonl}"
GH="${TO_GH_BIN:-gh}"
